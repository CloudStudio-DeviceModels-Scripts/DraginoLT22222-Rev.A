...
# Parsing + Configuration Script – Dragino LT22222 - Rev. A

This **Parsing + Configuration** script is designed for the **Dragino LT22222** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – Dragino LT22222 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **Dragino LT22222** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
